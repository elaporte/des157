...
document.form.onsubmit = process;
document.form.onreset = clear;
...
function process(){
  ...
  /*if (myMsg == "" || adj1 == "" || adj2 == "" || adj3 == "" || adj4 == "" || adj5 == "" || noun1 == "" || noun2 == "" || verb1 == "" || verb2 == "" || place1 == "" || place2 == "") {
    error.innerHTML = "Ya can't complete the song without all the lyrics!"
  } else {*/
